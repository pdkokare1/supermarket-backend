...
- [ ] **HQ Dashboard:** Verify the settlement ledger successfully split the payment, calculating the platform commission and the net payout owed to the Local Shop and Croma separately.# DailyPick: Day 1 Operations & Go-Live Manual
